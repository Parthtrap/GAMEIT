...
export default function NewMyModal(prop) {
    ...
    function onSaveChanges() {
        ...
        console.log({ title, content, selectedColor });
    }

    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-25 z-100 backdrop-blur-sm">
            <div className="container p-2 mx-auto mt-16 border border-gray-700 rounded-lg shadow-md bg-gr md:max-w-3xl">
                <div className="flex justify-between mx-5 my-5 md:mx-16">

                    <div className="flex -space-x-4 shadow-2xl shadow-purple-500/40 ">
                        ...
                        <div className="w-10 h-10 ease-in-out rounded-full bg-cyan-700 outline outline-1 outline-white hover:z-150 hover:scale-125" onClick={() => { setSelectedColor("bg-cyan-700") }}></div>
